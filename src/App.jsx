...
import giftPhoto from "./assets/mygf/Snapchat-527428363.jpg";   // apni fav pic lagao
import rosePetal from "./assets/GifData/RoseCute.gif";
import GiftGallery from "./GiftGallery";

import photo1 from "./assets/mygf/IMG_20250813_163425_812.jpg";
import photo2 from "./assets/mygf/IMG-20250420-WA0013.jpg";
import photo3 from "./assets/mygf/Screenshot_20250822-115439.png";
import photo4 from "./assets/mygf/Snapchat-1615974260.jpg";
import photo5 from "./assets/mygf/Snapchat-527428363.jpg";
import photo6 from "./assets/mygf/IMG-20241002-WA0004.jpg";
import photo7 from "./assets/mygf/IMG-20240814-WA0040.jpg";
import photo8 from "./assets/mygf/IMG_20250813_163425_812.jpg";
import photo9 from "./assets/mygf/IMG_20240929_145357_578.jpg";
import photo10 from "./assets/mygf/IMG_20240730_184813_372.jpg";
const HeartPhotos = [
...
export default function Page() {
    ...
    if (!isUnlocked) {
      Swal.fire({
        ...
        <p style="margin-bottom:10px">
          Sirf mere hubby ke liye ek secret door hai 😌✨<br/>
          Password likho aur memories unlock karo...
        </p>
        <input id="romanticPass" 
               class="swal2-input" 
               placeholder="Enter Password ❤️"/>
      `,
        confirmButtonText: "Unlock Love 🔐",
        allowOutsideClick: false,
        backdrop: "rgba(255,105,180,0.35)",
        background: "rgba(30,0,30,0.85)",
        preConfirm: () => {
          const val = document.getElementById("romanticPass").value;
          if (val.toLowerCase() !== "my hubby abhay") {
            Swal.showValidationMessage("Wrong password 😝 Try again my love");
            return false;
          }
          return true;
        }
  ...
  const handleGiftClick = () => {
    ...
    Swal.fire({
      ...
      <div class="gift-popup">
        ...
        <button id="openGalleryBtn" class="mini-gift-btn">🎁</button>

        <img src="${giftPhoto}" class="gift-img"/>
        <h2 class="gift-title">For My Beautiful Love 💖</h2>
        <p class="gift-text">
          Tum meri life ka sabse beautiful part ho.
          Har smile, har moment tumhare saath special lagta hai.
          I promise main hamesha tumhe aise hi pyaar karta rahunga ❤️
        </p>
      </div>
    `,
      confirmButtonText: "I Love You too my Baccha 😘",
      ...
      didOpen: () => {
        ...
        // 🎁 छोटा gift button click
        const btn = document.getElementById("openGalleryBtn");

        if (btn) {
          btn.onclick = () => {

            const galleryHTML = Object.values(
      ...
      `).join("");
          ...
          <div style="padding:20px">
            <h2 style="color:#ff4d88;margin-bottom:15px">
              Our Cute Memories 💖
            </h2>
        ...
        <img src="${src}"
          style="
            width:100%;
            border-radius:20px;
            box-shadow:0 0 25px rgba(255,100,150,0.9);
          "
        />
      `,
    ...
    setTimeout(() => {
      setShowPetals(false);
      setShowAura(false);   // ❗ true nahi — false
    }, 6000);
  };
  ...
  return (
    <>
      ...
      {showAura && <div className="cinematic-aura"></div>}
      ...
      {isUnlocked && (
        <div className="overflow-hidden flex flex-col items-center justify-center pt-4 h-screen -mt-16  selection:bg-rose-600 selection:text-white text-zinc-900">
          ...
          {yesPressed && noCount > 3 && (
            <button
              onClick={handleGiftClick}   // 👈 IMPORTANT
              className="fixed bottom-6 left-1/2 -translate-x-1/2
  bg-gradient-to-r from-pink-400 to-rose-500
  text-white px-7 py-3 rounded-full
  shadow-[0_0_20px_rgba(255,100,150,0.7)]
  hover:shadow-[0_0_35px_rgba(255,100,150,1)]
...
const HeartPhotoGallery = () => {
  return (
    <>
      {HeartPhotos.map((src, index) => (
        <img
          key={index}
          src={src}
          className={`heart-photo photo-${index}`}
          alt="love"
        />
      ))}
    </>
